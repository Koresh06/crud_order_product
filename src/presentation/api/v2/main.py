...
from src.presentation.api.v2.routers.product import router as product_router
from src.presentation.api.v2.routers.order import router as order_router
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(title="CRUD v2")

    app.add_middleware(RateLimitingMiddleware)

    app.include_router(product_router, prefix="/api/v2")
    app.include_router(order_router, prefix="/api/v2")
